...
plot_series('tke', '$m^2/s^2$', 'xyz-averaged TKE', (0, 0.015), 1)
plot_2dfield('tke_z', 'z-averaged TKE, $m^2/s^2$', 2)
plot_2dfield('tke_est_z', 'z-averaged estimation of TKE, $m^2/s^2$', 3)
plot_2dfield('ediss_z', 'z-averaged $E_{diss}$, $m^2/s^3$', 4)
plot_2dfield('eback_z', 'z-averaged $E_{back}$, $m^2/s^3$', 5)
plot_average_xy('tke', 'TKE, $m^2/s^2$', 'xy-averaged TKE', (0, 0.15), 6)
plot_average_xy('eback', '$m^2/s^3$', 'xy-averaged $E_{back}$', (0, 5e-8), 7)
plot_average_xy('ediss', '$m^2/s^3$', 'xy-averaged $E_{diss}$', (0, 5e-8), 8)
plot_series('avr_cdiss', '', 'average $c_{diss}$, i.e. $\overline{E_{back}} / \overline{E_{diss}}$', (0, 1), 9)
